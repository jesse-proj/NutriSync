    ...
    >
      ...
      <header className="w-full sticky top-0 z-50 bg-surface shadow-sm h-20 border-b border-outline-variant/30">
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 flex justify-between items-center h-full">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a
              href="#"
              className="font-label-md text-label-md text-primary border-b-2 border-primary pb-1 font-medium"
            >
              Solutions
            </a>
            <a
          ...
          <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-5 md:space-y-6 text-center lg:text-left">
              ...
              <p className="text-base md:text-lg text-on-surface-variant max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Empowering Filipino homes with AI-driven Remote Patient
                Monitoring. Bridge the gap between clinical excellence and daily
                wellness.
              </p>
              ...
              <div className="absolute -bottom-8 -left-8 bg-white/70 backdrop-blur-md border border-white/30 p-6 rounded-xl shadow-xl max-w-xs hidden md:block">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-on-surface-variant font-medium">
                    Daily vitals synced across 2,400+ patients today.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-surface-container-low">
          <div className="max-w-[1280px] mx-auto px-6 md:px-8">
            <div className="mb-12 text-center">
              <span className="text-primary text-xs font-semibold tracking-widest uppercase block mb-1">
                WHY TRADITIONAL APPS FAIL
              </span>
              <h2 className="text-2xl md:text-3xl font-bold mt-2">
                Filipino patients deserve better
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-colors">
                ...
                <h3 className="text-lg font-bold mb-2 text-on-surface">
                  No local food recognition
                </h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Apps like MyFitnessPal can't distinguish Sinigang from generic
                  vegetable soup, producing inaccurate nutritional data.
                </p>
              </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-colors">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Patients can't translate "2g sodium" into everyday meals like
                  tuyo, instant noodles, or adobo without help.
                </p>
              </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-colors">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Clinicians have no visibility into patient compliance between
                  visits, leading to preventable readmissions.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="py-16">
          <div className="max-w-[1280px] mx-auto px-6 md:px-8">
            <div className="mb-12 max-w-2xl mx-auto text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mt-2">
                Clinical monitoring reimagined for the local context
              </h2>
            </div>

            <div className="grid lg:grid-cols-3 gap-6">
              {/* Feature 1: Photo-Based Logging */}
              <div className="bg-surface shadow-sm rounded-xl overflow-hidden hover:shadow-xl border border-outline-variant/30 flex flex-col transition-all duration-150">
                <div className="h-64 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <span className="bg-secondary text-on-secondary px-2.5 py-1 rounded text-xs font-semibold">
                      AI-Powered
                    </span>
                  </div>
                </div>
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant mb-4 leading-relaxed font-normal">
                      Our AI is trained on over 50,000 local Filipino dishes.
                      Simply snap a photo of your Adobo, Kare-kare, or Sinigang
              ...
              <div className="bg-surface shadow-sm rounded-xl overflow-hidden hover:shadow-xl border border-outline-variant/30 flex flex-col transition-all duration-150">
                <div className="h-64 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-on-surface/60 to-transparent"></div>
                  <div className="absolute bottom-4 left-4">
                    <span className="bg-primary text-on-primary px-2.5 py-1 rounded text-xs font-semibold">
                      24/7 Companion
                    </span>
                  </div>
                </div>
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-bold mb-2">
                      NutriGabay Tagalog Chatbot
                    </h3>
                    <p className="text-sm text-on-surface-variant mb-4 leading-relaxed font-normal">
                      A conversational health companion that speaks your
                      language. Ask in Tagalog or Taglish about your diet,
                      medication, or wellness goals.
                    </p>
                  </div>
                  <div className="flex items-center gap-2 text-primary font-semibold text-sm">
              ...
              <div className="bg-surface shadow-sm rounded-xl overflow-hidden hover:shadow-xl border border-outline-variant/30 flex flex-col transition-all duration-150">
                <div className="h-64 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-on-surface/60 to-transparent"></div>
                  <div className="absolute bottom-4 left-4">
                    <span className="bg-error text-on-error px-2.5 py-1 rounded text-xs font-semibold">
                      Real-time Alert
                    </span>
                  </div>
                </div>
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant mb-4 leading-relaxed font-normal">
                      Critical alerts are sent directly to your doctor's
                      dashboard. Enable faster interventions and data-backed
        ...
        <section className="py-16 bg-surface-container-low">
          <div className="max-w-[1280px] mx-auto px-6 md:px-8">
            <div className="mb-12 text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mt-2 text-on-surface">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-on-surface-variant">
                      58 · Cavite · Post-stroke recovery
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-1 rounded-full border border-primary/20">
                    ...
                    <span className="text-xs text-primary font-semibold">
                      Budget Android · Tagalog-first
                    </span>
                  </div>
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    Can't translate "2g sodium" into real meals. Finds
                    calorie-counting apps frustrating and can't afford a
                    dietitian.
                  </p>
                </div>
                <Button
              ...
              <div className="bg-surface-container-lowest p-5 sm:p-8 rounded-xl border border-outline-variant hover:border-primary/30 flex flex-col gap-5 sm:gap-6 shadow-sm transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-secondary-container/20 text-secondary flex items-center justify-center font-bold text-lg">
                    MS
                  </div>
                  <div>
                    <h4 className="text-lg font-bold text-on-surface">
                    ...
                    <p className="text-xs text-on-surface-variant">
                      Cardiologist · Provincial public hospital
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 bg-secondary/10 px-4 py-1 rounded-full border border-secondary/20">
                    ...
                    <span className="text-xs text-secondary font-semibold">
                      Desktop + iPad · 80+ patients
                    </span>
                  </div>
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    No visibility into patient compliance between visits. Needs
                    exception-based alerts — not a system that pings for minor
                    infractions.
                  </p>
                </div>
                <Button
            ...
            <div className="relative flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="relative z-10 flex-1 text-center group">
                ...
                <p className="text-sm text-on-surface-variant px-4 leading-relaxed">
                  Take a quick photo of your meal or log your vitals in seconds
              ...
              <div className="relative z-10 flex-1 text-center group">
                ...
                <p className="text-sm text-on-surface-variant px-4 leading-relaxed">
                  Our localized AI calculates nutritional value and trends
                  specifically for Filipino dietary habits.
                </p>
              </div>
              ...
              <div className="relative z-10 flex-1 text-center group">
                ...
                <p className="text-sm text-on-surface-variant px-4 leading-relaxed">
                  Data is automatically analyzed and shared with your medical
                  provider for proactive care.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-surface-container-high rounded-xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="flex-1 space-y-6">
                <h2 className="text-2xl md:text-3xl font-bold">
                  Data Privacy <span className="text-primary">Guaranteed</span>
                </h2>
                <p className="text-sm text-on-surface-variant max-w-lg leading-relaxed">
                  Your medical data is processed under Philippine Data Privacy
                  Act of 2012 (RA 10173). AES-256 encryption at rest, HTTPS/TLS
                  in transit. Your clinician can only see your data — no one
                  else's.
                </p>
        ...
        <section className="py-16 relative overflow-hidden bg-primary-container">
          <div className="max-w-[1280px] mx-auto px-6 md:px-8 text-center py-12 text-on-primary-container space-y-6">
            ...
            <p className="text-base max-w-xl mx-auto opacity-90 leading-relaxed text-white">
              Join thousands of Filipino patients and clinicians bridging the
              gap in modern healthcare.
            </p>
            <Button
              onClick={() => navigate("/register")}
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-12">
            <div className="space-y-4 max-w-xs">
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed">
                The future of remote patient monitoring, designed for the unique
                needs of Filipino families and healthcare systems.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-outline-variant/30 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-xs text-on-surface-variant font-medium">
              © 2026 NutriSync . HIPAA &amp; DPA 2012 Compliant. All rights
              reserved.
            </p>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className={`w-12 h-12 rounded-full shadow-lg border border-outline-variant flex items-center justify-center transition-colors cursor-pointer ${
            isTextLarge
