      ...
      <section className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary">
        ...
        <div className="relative z-10 flex flex-col justify-end p-16 text-white">
          ...
          <p className="text-[0.95rem] leading-relaxed text-white/85 max-w-sm">
            Join thousands of patients and healthcare providers using NutriSync
            RPM for precise, intelligent nutritional monitoring.
          </p>
        </div>
      </section>
        ...
        <div className="w-full max-w-[400px] flex flex-col items-center">
          ...
          <div className="text-center mb-5">
            ...
            <p className="font-body-sm text-body-sm text-on-surface-variant">
              Intelligent monitoring for your nutritional health
            </p>
          ...
          {error && (
            <div
              className="w-full p-3 mb-3 text-sm text-red-800 bg-red-50 rounded-lg border border-red-200"
              role="alert"
            >
              {error}
            </div>
          ...
          <div className="mt-5 text-center">
            <p className="font-body-sm text-body-sm text-on-surface-variant">
              ...
              <Link
                className="text-primary font-label-md hover:underline ml-1"
                to="/register"
              >
                Sign up
              </Link>
